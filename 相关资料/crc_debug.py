...
def icap_crc(addr,data,crc):
    ...
    crc_data_in = [int(bit) for bit in crc_data_in] # 右高左低，将5位address拼到左侧高5位，低32位是data，然后反转
...
file_path = "E:\\workspace\\parse_bitstream\\parse_bitstream\\data\\system_wrapper_1_原版.bit"
